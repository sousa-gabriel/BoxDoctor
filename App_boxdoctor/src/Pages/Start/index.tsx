...
const Login: React.FC = () =>{
    ...
    return (
        <>
            ...
            {
                status === 0 ?
                    <TouchableOpacity style={{flex:1, width: '100%'}} onPress={fadeIn(1)}></TouchableOpacity>
                :status === 1?
                    <TouchableOpacity style={{flex:1,backgroundColor:'trasparent', width: '100%', }} onPress={()=>{fadeOut()}}>
